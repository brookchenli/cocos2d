...
bool CocosDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("TestJs002");
#else
        glview = cocos2d::GLViewImpl::createWithRect("TestJs002", Rect(0,0,960,640));
#endif
...
void CocosDelegate::startCocosScene001()
{
     log("CocosDelegate::startCocosScene001....");
    //ScriptingCore::getInstance()->executeGlobalFunction("startJsCocosScene001");
}

void CocosDelegate::startCocosScene002()
{
    log("CocosDelegate::startCocosScene002....");
    ScriptingCore::getInstance()->executeGlobalFunction("startJsCocosScene002");
}

void CocosDelegate::exitLuaGameView()
{
}
